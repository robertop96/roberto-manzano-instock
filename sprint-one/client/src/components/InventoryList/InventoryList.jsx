    ...
    return (
        ...
        <div className="inventory">
            <div className="searchI">
                ...
                <div>
                   <Link> <button className="searchI__button">+ Add New Item </button></Link>
                </div>
            </div>
            <div className="barI">
        ...
        {responseData?.map((data)=>{
                ...
                <div key={data.id}>
                    ...
                    <div className="cardI">           
                        ...
                        <div>
                            <Link to={`/`}><img className="cardI__img--delete" src={del} /></Link>
                        </div>
                        ...
                        <div className="cardI__icons">
                            <div>
                            <Link> <img className="cardI__img--delete2" src={del} />
                            </Link>
                            </div>
                           <Link to={`/inventory/${data.id}`}> <img className="cardI__img--edit" src={edit} /></Link>
                        </div>
                    </div>
                </div>
                )
